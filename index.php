        ...
        <body>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8"><font color="#000"><center><strong><h1>clases</h1></strong><h3>entrgada</h3></center></font></div>
                    <div class="col-md-2"></div>
                </div>
                </div>
    <h3>    
                            ...
                            <center>
                                ...
                                <form class="form-inline" method="POST" action="registro.php" name="login">
                                    ...
                                    <p><input type="submit" id="enviar" class="btn btn-success" value="INICIAR SESIÓN" name="btn_index">
                                     <a class="btn btn btn-danger" href="" role="button">SALIR</a></p>
                                </form>
                            </center>
                        </div>
                    </div>
